    ...
    <main>
        <nav class="flex-shrink-0 p-3 bg-dark" style="width: 280px;">
            ...
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed text-light" data-bs-toggle="collapse" data-bs-target="#categoria-collapse" aria-expanded="false">
                        Categoria
                    </button>
                    <div class="collapse" id="categoria-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li class="my-2"><a href="listar-categoria.php" class="link-light rounded">Relação de Categorias</a></li>
                        </ul>
                    </div>
                </li>

                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed text-light" data-bs-toggle="collapse" data-bs-target="#produto-categoria" aria-expanded="false">
                        Produtos
                    </button>
                    <div class="collapse" id="produto-categoria">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li class="my-2"><a href="cadastrar-produto.php" class="link-light rounded">Cadastrar Categoria</a></li>
                            <li class="my-2"><a href="listar-produto.php" class="link-light rounded">Relação de Produtos</a></li>
                        </ul>
                    </div>
                </li>
